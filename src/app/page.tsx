...
const Home = () => {
  ...
  const prompt =
    vibe === "Funny"
      ? `Generate 2 funny and catchy intros with no hashtags and clearly labeled "1." and "2.". Make sure there is a joke in there and it's a little ridiculous. Make sure each generated intro is at max 30 words and base it on this context: ${bio}${
          bio.slice(-1) === "." ? "" : "."
        }`
      : `Generate 2 ${vibe} catchy intros with no hashtags and clearly labeled "1." and "2.". Make sure each generated intro is at least 20 words and at max 30 words and base them on this context: ${bio}${
          bio.slice(-1) === "." ? "" : "."
        }`
